...
public class AnswerValidationFactory {
	...
	public static void validateAnswerId(Long ansId) 
	...
	public static void validateAddAnswer(AnswerEntity answer) 
			throws ForumException {
		Boolean check = false;
	...
	public static void validateUpdateAnswer(Long ansId, AnswerEntity answer) 
			throws ForumException {
		Boolean check = false;
		check = ValidationUtility.isNull(answer);
	...
	public static void validateLikeOperation(Long ansId, AnswerLikeEntity ansLike) 
			throws ForumException {
		Boolean check = false;
		check = ValidationUtility.isNull(ansId);
