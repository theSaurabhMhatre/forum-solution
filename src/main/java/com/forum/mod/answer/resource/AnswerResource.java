...
public class AnswerResource {
    ...
    public Response getAnswersByQuestion(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response addAnswer(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                              AnswerEntity answer) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateAnswer(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                                 @PathParam("ansId") Long ansId,
                                 AnswerEntity answer) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response deleteAnswer(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                                 @PathParam("ansId") Long ansId) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response likeAnswer(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                               @PathParam("ansId") Long ansId,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response dislikeAnswer(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                                  @PathParam("ansId") Long ansId,
                                  AnswerLikeEntity ansLike) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAnswersLikedByUser(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getUsersAnswersLikes(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                                         @PathParam("userId") Long userId) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAnswerByQuesAnsPair(@ApiParam(hidden = true) @Auth UserEntity userEntityAuth,
                                           @PathParam("ansId") Long ansId,
                                           @PathParam("quesId") Long quesId) {
