...
public class QuestionValidationFactory {
	...
	public static void validateQuestionId(Long quesId) 
	...
	public static void validateAddQuestion(QuestionEntity question) 
			throws ForumException {
		Boolean check = false;
	...
	public static void validateUpdateQuestion(Long quesId, QuestionEntity question) 
			throws ForumException {
		Boolean check = false;
		check = ValidationUtility.isNull(question);
	...
	public static void validateLikeOperation(Long quesId, QuestionLikeEntity quesLike) 
			throws ForumException {
		Boolean check = false;
		check = ValidationUtility.isNull(quesId);
