...
/**
 * This class uses the queries defined in QuestionLikeEntity to query
...
public class QuestionLikeRepo {
	...
	public void deleteQuesLikesByQuesId(Long quesId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("deleteQuesLikesByQuesIdQuery").setParameter("quesId", quesId);
		query.executeUpdate();
	}

	public void deleteQuesLikesByUserId(Long userId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("deleteQuesLikesByUserIdQuery").setParameter("userId", userId);
		query.executeUpdate();
	}

	public List<Object> getLikesByQuestionsOld(String keyword, String category) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("getLikesByQuestionsQuery").setParameter("keyword", keyword)
				.setParameter("category", category);
		List<Object> quesLikes = query.getResultList();
		return quesLikes;
	}
	...
	public List<Object> getLikesByQuestionsByUser(Long userId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedNativeQuery("getLikesByQuestionsByUserQuery").setParameter("userId", userId)
				.addScalar("qlikes", LongType.INSTANCE).addScalar("quesId", LongType.INSTANCE);
		List<Object> quesLikes = query.getResultList();
		return quesLikes;
	}
	...
	public Long getLikesByQuestion(Long quesId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("getLikesByQuestionQuery").setParameter("quesId", quesId);
	...
	public List<Object> getLikesBySpecificQuestions(List<Long> quesIds) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("getLikesBySpecificQuestionsQuery").setParameterList("quesIds", quesIds);
		List<Object> quesLikes = query.getResultList();
		return quesLikes;
	}
	...
	public List<Integer> getQuestionsLikedByUser(Long userId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedQuery("getQuestionsLikedByUserQuery").setParameter("userId", userId);
		List<Integer> questionLikes = query.getResultList();
		return questionLikes;
	}

	public Long getUsersQuestionsLikes(Long userId) {
		Session session = sessionFactory.getCurrentSession();
		Query query = session.getNamedNativeQuery("getUsersQuestionsLikesQuery").setParameter("userId", userId)
	...
	public List<Object> getAllUsersQuestionsLikes() {
		...
		List<Object> quesLikesByUsers = query.getResultList();
